...
for i in [39, 40, 41]:
    print(f"Cell {i}: {''.join(nb['cells'][i]['source'])[:80]}")
...
for lines, label in [(cell40_lines, 'Cell40'), (cell41_lines, 'Cell41')]:
    try:
...
nb['cells'][40]['source'] = cell40_lines
nb['cells'][40]['outputs'] = []
nb['cells'][40]['execution_count'] = None

nb['cells'][41]['source'] = cell41_lines
nb['cells'][41]['outputs'] = []
