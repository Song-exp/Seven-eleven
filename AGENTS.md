...
* 탐색적 데이터 분석(EDA) 및 시각화 작업: `eda/.Codex-rules.md`
* 데이터 전처리 및 그래프 생성 작업: `src/data_builder/.Codex-rules.md`
* GNN 모델 아키텍처 설계 및 수정: `src/models/.Codex-rules.md`
* 학습 루프 및 최적화 작업: `src/train/.Codex-rules.md`
